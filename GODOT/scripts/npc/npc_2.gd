...
@export var dialogue_resource_es: Resource = preload("res://dialogue/shopkeeper_es.dialogue")
@export var dialogue_resource_ja: Resource = preload("res://dialogue/shopkeeper_ja.dialogue")
